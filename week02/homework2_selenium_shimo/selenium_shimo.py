...
try:
    driver.find_element_by_css_selector("input[type='text']").send_keys('136XXXXXXXX')
    driver.find_element_by_css_selector("input[type='password']").send_keys('XXXXXXXXXXX')
